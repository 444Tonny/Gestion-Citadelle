...
{{ Form::open(['route' => 'sendAuto', 'method' => 'post', 'id' => 'templateForm']) }}
        ...
        <div class="row">
            <div class="row">
                ...
                <div class="form-group col-md-6 col-lg-6">
                    ...
                    <select name="interval" class="form-control">
                        ...
                        <option value="90">Chaque 3 mois</option>
                        <option value="180">Chaque 6 mois</option>
                    </select>
                </div>
                ...
                <div class="form-group col-md-6 col-lg-6">
                    ...
                    <input type="number" name="dayOfMonth" class="form-control" placeholder="1-31" min="1" max="31" required>
                </div>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    var intervalSelect = document.querySelector('select[name="interval"]');
                    var monthSelect = document.querySelector('select[name="month"]');

                    // Écoutez les changements dans le champ 'interval'
                    intervalSelect.addEventListener('change', function () {
                        // Récupérez la valeur sélectionnée
                        var selectedValue = intervalSelect.value;

                        // Désactivez ou activez le champ 'month' en fonction de la sélection
                        if (selectedValue === '7' || selectedValue === '14' || selectedValue === '30') {
